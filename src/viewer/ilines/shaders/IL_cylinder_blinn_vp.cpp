/* $Id: IL_cylinder_blinn_vp.cpp,v 1.5 2005/10/17 10:41:21 ovidiom Exp $ */

/**
 * @file  IL_cylinder_blinn_vp.cpp
...
namespace ILines
{
	 ...
	 *
	 * This vertex program computes for each vertex the viewing vector and
	 * the light vector passing them along with the application provided
	 * tangent vector to the fragment program in IL_cylinder_blinn_fp.cpp.
	 */
	const char *IL_cylinder_blinn_vp =
		"!!ARBvp1.0                                             \n"
		"                                                       \n"
		"# ******* attributes *********                         \n"
		"                                                       \n"
