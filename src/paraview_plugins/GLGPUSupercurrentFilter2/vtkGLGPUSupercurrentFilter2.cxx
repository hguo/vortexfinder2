#include "vtkGLGPUSupercurrentFilter2.h"
...
vtkStandardNewMacro(vtkGLGPUSupercurrentFilter2);

vtkGLGPUSupercurrentFilter2::vtkGLGPUSupercurrentFilter2()
{
...
int vtkGLGPUSupercurrentFilter2::RequestUpdateExtent(
    vtkInformation*, 
...
int vtkGLGPUSupercurrentFilter2::RequestData(
    vtkInformation*, 
    vtkInformationVector** inputVector, 
...
int vtkGLGPUSupercurrentFilter2::ComputeSupercurrent(vtkImageData* inputData, vtkImageData* outputData)
{
